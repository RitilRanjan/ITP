...
from Frontend import lex, reconstruct_string, parse_fol_formula, parse_prop_formula
...
def handle_contra(env: Environment, args_str: str) -> Environment:
    ...
    from Frontend import reconstruct_string, parse_fol_formula, parse_prop_formula
    from AST import Connective
    from SubstitutionManager import clone_ast
