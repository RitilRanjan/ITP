...
def update():
    with open('/Users/ritilranjan/ITP/StorageManager.py', 'r') as f:
        content = f.read()

    # We need to replace save_environment_state and load_environment_state
    # But wait, we can just redefine them.
...
"""
    ...
    with open('/Users/ritilranjan/ITP/StorageManager.py', 'w') as f:
        f.write(new_code)
