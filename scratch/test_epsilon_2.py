...
env.add_formula(Relation(name="R", arity=2, rel_type=RelationType.USER_DEFINED, arguments=[dummy, dummy]))
...
env.local_formulae["f1"] = parse_fol_formula("R x εz R x z", env)
