...
from backend.SubstitutionManager import clone_ast, substitute_all
from backend.GraphSearch import SearchLimits, SearchLimitExceeded, extract_vocabulary
from backend.Parser import reconstruct_string
from backend.Environment import Environment
from backend.ProofGenerator import ProofGenerator
...
def deskolemize_clause(clause_node: FormulaNode) -> FormulaNode:
    ...
    from backend.AST import Function, Variable, Quantifier
