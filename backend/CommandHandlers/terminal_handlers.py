...
def handle_help(env: Environment, args_str: str) -> None:
    ...
    print("\n  " + _bold("Arguments:"))
    print("    (occ)      : Comma-separated list of 1-based indices (e.g. (1,3)). Omit for all.")
    ...
    print("  ct  <name>|<\"pattern\"> <expr>  Create a term or custom notation")
    print("  cf  <name>|<\"pattern\"> <expr>  Create a formula or custom notation")
